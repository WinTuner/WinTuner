    ...
    <aside ref={sidebarRef} className="space-y-8 lg:sticky lg:top-28 lg:self-start">
      ...
      <div className={cn("opacity-0", isVisible && "animate-fade-in-up stagger-1")}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">{t.categories}</h3>
        </div>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">{t.newsletter}</h3>
        </div>
